...
class _WorkoutHistoryScreenState extends State<WorkoutHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            Text('Workout History', style: TextStyle(color: textPrimaryColor)),
        centerTitle: true,
        backgroundColor: backgroundColor,
        ...
        child: _isLoading
            ...
            : _errorMessage != null
                ...
                : _workoutHistory.isEmpty
                    ...
                    : _buildWorkoutHistoryList(context, cardBackgroundColor,
  ...
  Widget _buildStat(String label, String value, Color textPrimaryColor,
      Color textSecondaryColor) {
    return Column(
      children: [
        Text(
  ...
  void _showWorkoutHistoryDetails(
      BuildContext context, WorkoutHistory history) async {
    ...
    final Map<String, Exercise> exercisesMap =
        await Exercise.fetchExercisesByIds(exerciseIds);
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    ...
                    final muscleGroups = exercise?.getMuscleGroupString() ?? '';
